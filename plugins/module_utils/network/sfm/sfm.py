...
def get_connection(module):
    if hasattr(module, "_sfm_connection"):
        return module._sfm_connection

    capabilities = get_capabilities(module)
    network_api = capabilities.get("network_api")
    if network_api in ["cliconf", "sfm_rest"]:
        module._sfm_connection = Connection(module._socket_path)
    else:
...
def get_capabilities(module):
    if hasattr(module, "_sfm_capabilities"):
        return module._sfm_capabilities
    try:
        capabilities = Connection(module._socket_path).get_capabilities()
    except ConnectionError as exc:
        module.fail_json(msg=to_text(exc, errors="surrogate_then_replace"))
    module._sfm_capabilities = json.loads(capabilities)
    return module._sfm_capabilities
